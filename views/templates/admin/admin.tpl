...
<form action="{if isset($coinsnap_form)}{$coinsnap_form|escape:'htmlall':'UTF-8'}{/if}" id="module_form" class="defaultForm form-horizontal" method="post">
    <div class="panel" id="fieldset_0">    
        ...
        <div class="form-wrapper">
            ...
            <div class="form-group">                    
                <label class="control-label col-lg-3" for="coinsnap_provider">{l s='Provider:' mod='coinsnap'}</label>                                
                <div class="col-lg-3">
                    <select name="coinsnap_provider" id="coinsnap_provider" class="form-control">
                        <option value="coinsnap" {if 'coinsnap' == $coinsnap_provider} selected="selected"{/if}>Coinsnap</option>
                        <option value="btcpay" {if 'btcpay' == $coinsnap_provider} selected="selected"{/if}>BTCPay</option>
                    </select>             
                </div>
            </div>

            <div class="form-group coinsnap">            
            ...
            <div class="form-group btcpay">            
                <label  class="control-label col-lg-3" for="btcpay-server-url">{l s='BTCPay server URL*:' mod='coinsnap'}</label>
                <div class="col-lg-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="icon icon-tag"></i></span>
                        <input type="text" class="text" name="btcpay_server_url" id="btcpay-server-url" value="{$btcpay_server_url|escape:'htmlall':'UTF-8'}" />
                    </div>
                </div>
            </div>

            <div class="form-group btcpay">            
                <label  class="control-label col-lg-3" for="btcpay-store-id">{l s='Store ID*:' mod='coinsnap'}</label>
                <div class="col-lg-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="icon icon-tag"></i></span>
                        <input type="text" class="text" name="btcpay_store_id" id="btcpay-store-id" value="{$btcpay_store_id|escape:'htmlall':'UTF-8'}" />
                    </div>
                </div>
            </div>

            <div class="form-group btcpay">          
                <label class="control-label col-lg-3" for="btcpay-api-key">{l s='API Key*:' mod='coinsnap'}</label>
                <div class="col-lg-3">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="icon icon-tag"></i></span>
                        <input type="text" class="text" name="btcpay_api_key" id="btcpay-api-key" value="{$btcpay_api_key|escape:'htmlall':'UTF-8'}" />
                    </div>
                </div>
            </div>

            <div class="form-group">          
                <label class="control-label col-lg-3" for="coinsnap-autoredirect">{l s='Redirect after payment:' mod='coinsnap'}</label>
                <div class="col-lg-3">
    ...
    <div class="panel" id="fieldset_1">    
        ...
        <div class="panel-footer">
            <button type="submit" value="1" id="module_form_submit_btn" name="submitcoinsnap" class="btn btn-default pull-right"><i class="process-icon-save"></i> Save</button>
        </div>        
    </div>
</form>
